          ...
          <div className="flex min-h-[560px] flex-col justify-between gap-10">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="max-w-lg text-base leading-8 text-slate-300">
                  统一管理题库、考试、提交记录、人工复核与统计分析，让整套系统运行更稳定清晰。
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
                ...
                <p className="mt-2 text-2xl font-semibold text-white">集中维护</p>
                <p className="mt-3 text-sm leading-7 text-slate-300">
                  在同一个后台里完成出题、建卷、发布和更新。
                </p>
              </div>

              <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
                <p className="text-sm text-slate-300">评分与统计</p>
                <p className="mt-2 text-2xl font-semibold text-white">复核闭环</p>
                <p className="mt-3 text-sm leading-7 text-slate-300">
                  简答题人工复核与统计面板集中呈现，不再来回跳转。
                </p>
              </div>
            </div>
          </div>
